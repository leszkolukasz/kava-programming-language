...
interpreter : AbsGrammar.hs LexGrammar.hs ParGrammar.hs PrintGrammar.hs Main.hs TypeChecker.hs Interpreter.hs Types.hs Utils.hs
	${GHC} ${GHC_OPTS} Main.hs -o interpreter

# Rules for cleaning generated files.

clean :
	-rm -f *.hi *.o *.log *.aux *.dvi *.info *.bak *.y *.x
